...
class UserRegisterIntegrationTest {
  ...
  void shouldNotRegisterUserWithDuplicateUsername() throws Exception {
    ...
    UserRegisterDTO duplicateUsername =
        new UserRegisterDTO("john_doe", "other@example.com", "Secure123!");
    mockMvc
        .perform(
            post("/register")
                .with(csrf())
  ...
  void shouldNotRegisterUserWithDuplicateEmail() throws Exception {
    ...
    UserRegisterDTO duplicateEmail =
        new UserRegisterDTO("another_user", "john@example.com", "Secure123!");
    mockMvc
        .perform(
            post("/register")
                .with(csrf())
  ...
  void shouldNotRegisterUserWithInvalidPassword() throws Exception {
    UserRegisterDTO invalidPasswordUser =
        new UserRegisterDTO("weak_user", "weak@example.com", "123");
